...
//        // f&f=f; f&t=f; t&t=t;
//
//        System.out.printf("Prepared for a night without wifey: %b%n", hasPizzaRolls && hasPepsiWildCherry);
//        System.out.printf("Does Nick have something to guide him the darktimes: %b%n", hasPizzaRolls || hasPepsiWildCherry);
//        //t or f = true; f or f = f;
//
//        System.out.printf("Will Nick go hungry: %b%n", !hasPizzaRolls);
//        System.out.printf("Will Nick go thirsty: %b%n", !hasPepsiWildCherry);
//
//        System.out.println(sc.nextBoolean() && sc.nextBoolean());
       // System.out.println(sc.nextBoolean() || sc.nextBoolean());
        //if we type in false, it stops remember the t & f and t or f table.
        //establish boolean value first.

        //===== Math comparison's

//        System.out.println("Did you bring enough gum for the entire class? How many stick of gum do you have?");
...
//        System.out.printf("Knows who Hilary Duff is: %b%n", lizzieSeasons == 2);
        //works only with primitive data types

        //equality in strings
//        System.out.println("who was the 1994 and 1995 NBA finals MVP?");
//        String number34 = sc.nextLine();

        //comparisons with strings   "equals methods=needs exact input"
        //case agnostic string literal in equals? or equals ignore case
...
//            System.out.println("He didnt join the rockets until '95.");
