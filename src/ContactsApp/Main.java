...
class ContactManagerApplication {
    ...
    public static void viewAll() {
        if (phonebook != null) {
            for (Enumeration<String> e = phonebook.keys(); e.hasMoreElements(); ) {
                Contacts entry = phonebook.get(e.nextElement());
                entry.printInfo();
            }
        }
    }
    ...
    public static void addToPhoneBook() {
        ...
        try {
            ...
            String firstName = "";
            Contacts st = new Contacts(firstName, name, phone);
    ...
    public static void writeIt(Hashtable<String, Contacts> obj) {
        try {
    ...
    public static Hashtable<String, Contacts> readList() {
//    public static Hashtable<String, Contact> readList(Hashtable<String, Contact> obj) {
        Hashtable<String, Contacts> phonebook = null;
        try {
            Path p = Paths.get("contacts.txt");
            ArrayList<String> something = new ArrayList<>();
